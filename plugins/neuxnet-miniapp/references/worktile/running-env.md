---
title: "Running env"
source_url: https://miniapp.neuxnet.com/worktile/running-env.html
---
##  开发环境和生产环境
...
-   编译期判断 编译期判断，即条件编译，不同平台在编译出包后已经是不同的代码。详见：[条件编译](https://miniapp.neuxnet.com/platform)
...
其他环境变量的定义方式参考 [环境变量](../tutorial/env.md)。
