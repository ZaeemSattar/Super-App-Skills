---
title: "Event penetration"
source_url: https://miniapp.neuxnet.com/tutorial/nvue-event.html
---
`Weex` provides the ability to trigger actions through events, such as executing `JavaScript` when the user clicks on a component. Below are the common event attributes that can be added to weex components to define event actions.
