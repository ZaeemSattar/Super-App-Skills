...
source_url: https://miniapp.neuxnet.com/collocation/frame/subNVues.html
---
...
An instance of obtaining the `subNVues` native subwindow by `ID`. [subNVues configuration](../pages.md#app-subNVues)
...
Return a [subNVue](../../api/window/subNVues.md#subnvue) object
...
| --- | --- | --- | --- |
| aniShow | String | auto | Display the animation effect of the native subwindow. If the window animation type is not specified, the default value of "auto" will be used, i.e., the animation effect of the last displayed window will be automatically selected. If it has not been displayed before, the animation effect of "none" will be used. [See animation type for details](../../api/window/subNVues.md#%E5%8A%A8%E7%94%BB%E7%B1%BB%E5%9E%8B) |
